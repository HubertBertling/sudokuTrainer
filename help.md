...
5. [Die Welt der 9x9 Sudokus im Sudoku-Explorer](#die-welt-der-9x9-sudokus-im-sudoku-explorer)
   ...
   10. [Programm der Sudoku-Freaks](#programm-der-sudoku-freaks)
   11. [Wo finde ich 'Sehr schwere' oder 'Extrem schwere' Puzzles?](#wo-finde-ich-sehr-schwere-oder-extrem-schwere-puzzles)
...
Hinweis: Bei dieser Vorgehensweise wird automatisch der eingestellte Standard-Browser als Installationsbasis gewählt. Z.B. der Samsung-Internet-Browser. Besser ist es, Google-Chrome oder MS-Edge als Installationsbasis zu wählen, da diese Browser die PWA-Technoloogie am besten unterstützen. Firefox unterstützt die PWA-Technolgie nicht out-of-the-box, sondern benötigt dafür ein ein spezielles Add-on. Dieses Add-on wird von Mozilla nicht aktiv auf seine Sicherheit überwacht. Das klingt nicht besonders vertrauenswürdig. Wenn Chrome nicht als Standard-Browser eingestellt ist, kann man den Link aus der WhatsApp-Nachricht kopieren, den Chrome-Browser öffnen und den kopierten Link in das URL-Feld einfügen. Danach läuft alles wie beschrieben.
...
| Zelle                                                                                                 | Bedeutung                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Given](./imagesHelp/definedCell.png)                                                                | **Eine gegebene Nummer (Given):** In der Definitionsphase gesetzte Nummer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ![Solved](./imagesHelp/playedCell.png)                                                                | **Eine Lösungsnummer:** In der Lösungsphase gesetzte Nummer. In dieser Zelle wurde in der Lösungsphase manuell oder automatisch die Nummer 1 gesetzt.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ![CandidatesEempty](./imagesHelp/zeroCandidates.png) ![Candidates](./imagesHelp/optionCell.png)       | **Kandidaten:** Für diese Zelle wurde noch keine Nummer gesetzt. Das sind die Kandidaten der Zelle. Im Auswertungsmodus "Keine" ist die Zelle leer, im Modus "Lazy" zeigt sie ihre Kandidaten: Nur noch eine der Nummern 3, 5, 6 und 9 kann gewählt werden. Die nicht aufgeführten Nummern sind unzulässig, weil sie bereits in einer anderen Zelle des Blocks, der Reihe oder Spalte gesetzt sind.                                                                                                                                                                                                                                                                                                                                                                             |
| ![Necessary](./imagesHelp/neccessary.png)                                                             | **Notwendiger Kandidat:** Für die nebenstehende Zelle wurde noch keine Nummer gesetzt. Kandidatnummern sind die Nummern 1, 3 und 4. Jedoch hat der Solver ermittelt, dass der Kandidat 1 notwendig ist, damit das Sudoku lösbar bleibt. 1 ist eine notwendige Nummer für diese Zelle. Ein Kandidat in einer Zelle ist notwendig, wenn die Kandidatnummer in ihrem Block, in ihrer Reihe oder Spalte einzig ist. D.h. sie kann nur noch hier gesetzt werden. Hinweis: Im Wikipedia-Artikel [Wikipedia](https://en.wikipedia.org/wiki/Glossary_of_Sudoku) werden notwendige Kandidaten als "Hidden Singles" bezeichnet. Wir wollen diese Bezeichnung hier nicht übernehmen, weil wir diese Bezeichnung schon anderweitig benutzen: siehe nachfolgende Definition 'Hidden Single'. |
| ![Necessary](./imagesHelp/neccessarySelected1.png) ![Necessary](./imagesHelp/neccessarySelected2.png) | **Notwendiger Kandidat selektiert:** Eine Zelle mit notwendigem Kandidat wurde selektiert. Die obere Zelle im "Keine" Auswertungsmodus, die untere im Lazy-Modus.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ![Inadmissible candidates](./imagesHelp/indirect.png)                                                 | **Eliminierbarer Kandidat:** Für die nebenstehende Zelle wurde noch keine Nummer gesetzt. Kandidaten dieser Zelle sind die drei Nummern 2, 4 und 6. Jedoch hat der Solver ermittelt, dass die Kandidatnummer 6 unzulässig ist. Wenn man sie setzen würde, würde der Solver sofort oder einige Schritte später die Widersprüchlichkeit des Puzzles feststellen.                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ![Single](./imagesHelp/nakedSingle.png)                                                               | **Einziger Kandidat (Single):** Eine Single-Nummer ist der Kandidat in einer Zelle, wenn es keine weiteren Kandidaten in der Zelle gibt. Im nebenstehendem Beispiel ist 3 ein Single.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ![Hidden single](./imagesHelp/indirekterSingle.png)                                                   | **Versteckt einziger Kandidat (Hidden Single):** im nebenstehenden Beispiel ist die 7 ein Versteckt einziger Kandidat. Die 7 ist in dieser Zelle ein Hidden Single, weil die anderen Kandidaten, die rote 3 und 4, eliminierbare Kandidaten sind.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ![No candidates at all](./imagesHelp/nochoice2.png)                                                   | **Widerspruch - Kein Kandidat:** Für diese Zelle wurde noch keine Nummer gesetzt. Allerdings gibt es keinen Kandidat mehr, der noch gesetzt werden könnte.  Wenn das Puzzle noch erfolgreich gelöst werden soll, müssen ein oder mehrere der bisherigen Nummernsetzungen zurückgenommen werden. Tritt während der automatischen Ausführung eine solche Zelle auf, schaltet der Solver in den Rückwärts-Modus um.                                                                                                                                                                                                                                                                                                                                                                |
| ![NumberConflict](./imagesHelp/conflct.png) ![NumberConflictGiven](./imagesHelp/conflictBlau.png)     | **Widerspruch - Die Nummer 1 ist bereits einmal gesetzt:** Für diese Zelle wurde die Nummer 1 gesetzt. Diese Nummer ist direkt unzulässig, weil in der Spalte, Reihe oder dem Block dieser Zelle bereits eine 1 gesetzt ist. Das zweite oder dritte Auftreten der Nummer wird ebenfalls mit rotem Rand angezeigt.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
**Schiebetaste "Eingeben - Lösen".** Für das Eingeben eines Puzzles muss dieser Schalter auf "Eingeben" gesetzt werden. Nach Beendigung der Eingabe wird der Schalter auf "Lösen" gesetzt. Im Hintergrund berechnet der Explorer den Schwierigkeitsgrad des eingegebenen Puzzles und zeigt diesen oben rechts über der Matrix an.
...
![NumberConflictGiven](./imagesHelp/conflictBlau.png)
...
Es gibt Puzzles, die eine eindeutige Lösung haben, aber für sie wurde bisher noch keine logische Herleitung der Lösung gefunden. Eine Diskussion über die härtesten Sudukus findest du hier [Arto_Inkala_Sudoku](https://www.sudokuwiki.org/Arto_Inkala_Sudoku). Das wohl bekannteste Sudoku ohne logische Lösung ist 
...
|8. | Nicht alle Puzzles mit eindeutiger Lösung können durch logisches Schließen gelöst werden. |
|9. | Tatsache: Es gibt einen Wettbewerb um das härteste Sudoku. |
|10. |Empfehlung: Vor Lösungsssuche Schwierigkeitsgrad prüfen. |
|11. |Tatsache: Eindeutige Puzzles können per Backtracking gelöst werden. |
|12. | Beobachtung: Logisches Schließen und Backtracking ineinander verschränkt können die Lösungssuche vereinfachen. |
...
Die Erfahrung/Vermutung 8, dass nicht alle Puzzles mit eindeutiger Lösung durch logisches Schließen gelöst werden können, führt zum Streit bzw. Wettbewerb um das härteste Sudoku.

Ende November 2006 behauptete der finnische Mathematiker Arto Inkala, das schwierigste Sudoku der Welt entwickelt zu haben. „Ich habe das Rätsel AI Escargot genannt, weil es wie eine Schnecke aussieht. Es zu lösen ist wie ein intellektuelles kulinarisches Vergnügen. AI sind meine Initialen”, sagte er. AI-Escargot: [https://www.sudokuwiki.org/Escargot](https://www.sudokuwiki.org/Escargot) " ... the world's hardest Sudoku?" 
100007090030020008009600500005300900010080002600004000300000010040000007007000300

**10. Empfehlung: Vor Lösungsssuche Schwierigkeitsgrad prüfen.** 

Bevor man die Suche nach der Lösung für ein Puzzle beginnt, sollte man sich beispielsweise mit diesem Explorer den Schwierigkeitsgrad des Puzzles anzeigen lassen. Das vermeidet skurrile Diskussionen wie die folgende: 


<figure >
   <img src="./imagesHelp/turkeyDiscussion.png" alt="turkey discussion" style="max-width:100%">
    <figcaption style="font-size: 16px; font-style: italic;">Skurrile Discussion
</figcaption>
</figure>

Puzzle: 005300000800000020070010500400005300010000006003200080060500009004000030000009700

In der Tat ist das von S3ven-Six diskutierte Puzzle "getürkt". Es ist 'Extrem schwer' wie dieser Explorer nach der Eingabe feststellt. Und es hat 206 Lösungen wie dieser Explorer es berechnet und wie es auch Andrew Stuart feststellt. Für extrem schwere Puzzles gibt es keine eindeutigen Lösungen und damit auch keine logischen Herleitungen derselben.

<figure >
   <img src="./imagesHelp/turkey.png" alt="turkey" style="max-width:100%">
    <figcaption style="font-size: 16px; font-style: italic;">Logisch unlösbar, weil mehrfache Lösung, 206 Lösungen
</figcaption>
</figure>
...
**11. Tatsache: Es gibt nicht-elementar unlösbare Sudokus.**
