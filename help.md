...
* 6. [Sudoku-Theorie](#Sudoku-Theorie)
	...
	* 6.2. [</a>Notwendige Kandidaten](#aNotwendigeKandidaten)
...
##  1. <a name='Sudoku-TrainerInstallation'></a>Sudoku-Trainer Installation
...
##  2. <a name='EinfhrungindieApp'></a>Einführung in die App

###  2.1. <a name='TrainerfrklassischesSudoku'></a>Trainer für klassisches Sudoku
...
###  2.3. <a name='DiemglichenInhalteeinerSudoku-Zelle'></a>Die möglichen Inhalte einer Sudoku-Zelle
...
###  2.4. <a name='ZweiSpielphasen'></a>Zwei Spielphasen
...
###  2.5. <a name='JederLsungsschrittmitzweiSubschritten'></a>Jeder Lösungsschritt mit zwei Subschritten
...
###  2.6. <a name='Trainer-Operationen'></a>Trainer-Operationen
...
###  2.7. <a name='Solver-Einstellungen'></a>Solver-Einstellungen
...
##  3. <a name='DerautomatischeSolver'></a>Der automatische Solver
...
###  3.1. <a name='WiewhltderSolverdienchsteZelleunddieinihrzusetzendeNummer'></a>Wie wählt der Solver die nächste Zelle und die in ihr zu setzende Nummer?
...
###  3.2. <a name='WieprftderSolverdieneugesetzteNummer'></a>Wie prüft der Solver die neu gesetzte Nummer?
...
###  3.3. <a name='VorwrtsundRckwrtsBacktracking'></a>Vorwärts und Rückwärts (Backtracking)
...
##  4. <a name='NutzungsformendesSudoku-Trainers'></a>Nutzungsformen des Sudoku-Trainers

###  4.1. <a name='ManuellesLsen'></a>Manuelles Lösen
...
###  4.2. <a name='AutomatischesLsen'></a>Automatisches Lösen
...
##  5. <a name='DiePuzzle-Datenbank'></a>Die Puzzle-Datenbank
...
###  5.1. <a name='OperationenderDatenbank'></a>Operationen der Datenbank
...
###  5.2. <a name='ImportExportundTeilenvonPuzzles'></a>Import/Export und Teilen von Puzzles
...
####  5.2.1. <a name='TeilenderSudoku-Trainer-AppURL'></a>Teilen der Sudoku-Trainer-App URL
...
####  5.2.2. <a name='PuzzlevonSmartPhonezuSmartPhone'></a>Puzzle von SmartPhone zu SmartPhone
...
####  5.2.3. <a name='PuzzleDatenbankvomPCaufdasSmartphonebertragen'></a>Puzzle Datenbank vom PC auf das Smartphone übertragen
...
###  5.3. <a name='DieinitialeDatenbankistnichtleer'></a>Die initiale Datenbank ist nicht leer
...
###  6.1. <a name='UnzulssigeNummernundKandidaten'></a>Unzulässige Nummern und Kandidaten
...
###  6.2. <a name='aNotwendigeKandidaten'></a>Notwendige Kandidaten
...
###  6.3. <a name='EinzigeKandidatenSingles'></a>Einzige Kandidaten (Singles)
...
###  6.4. <a name='UnzulssigeKandidatenundversteckteinzigeKandidaten'></a>Unzulässige Kandidaten und versteckt einzige Kandidaten
...
###  6.5. <a name='KriterienfrdieErkennungunzulssigerKandidaten'></a>Kriterien für die Erkennung unzulässiger Kandidaten

####  6.5.1. <a name='KriteriumNotwendigeNummer'></a>Kriterium "Notwendige Nummer"
...
####  6.5.2. <a name='KriteriumNacktesPaar'></a>Kriterium "Nacktes Paar"
...
####  6.5.3. <a name='Kriterium:VerstecktesPaar'></a>Kriterium: "Verstecktes Paar"
...
####  6.5.4. <a name='Kriterium:berschneidung'></a>Kriterium: Überschneidung
...
####  6.5.5. <a name='Kriterium:PointingPairPointingTriple'></a>Kriterium: Pointing Pair, Pointing Triple
...
###  6.6. <a name='MethodenderKandidatenauswertung'></a>Methoden der Kandidatenauswertung
...
###  6.7. <a name='VergleichderAuswertungsmodiLazyundStrikt'></a>Vergleich der Auswertungsmodi Lazy und Strikt
...
###  6.8. <a name='WiderspruchsvollePuzzles'></a>Widerspruchsvolle Puzzles
...
####  6.8.1. <a name='WiderspruchsvolleZellen'></a> Widerspruchsvolle Zellen
...
####  6.8.2. <a name='WiderspruchsvolleGruppen'></a>Widerspruchsvolle Gruppen
...
###  6.9. <a name='SchwierigkeitsgradeLevels'></a>Schwierigkeitsgrade (Levels)
...
###  6.10. <a name='bersichtberdieBedeutungderSchwierigkeitsgrade'></a>Übersicht über die Bedeutung der Schwierigkeitsgrade
...
###  6.11. <a name='WelcherSchwierigkeitsgradfrwelchenSpielertyp'></a>Welcher Schwierigkeitsgrad für welchen Spielertyp?
...
###  6.12. <a name='FairePuzzles'></a>Faire Puzzles
...
##  7. <a name='SudokuimInternet'></a>Sudoku im Internet
