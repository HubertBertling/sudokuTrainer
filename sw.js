...
var URLS = [
  ...
  `${GHPATH}/imagesHelp/zeroCandidates.png`,
  ...
  `${GHPATH}/imagesHelp/neccessarySelected1.png`,
  `${GHPATH}/imagesHelp/neccessarySelected2.png`,
  ...
  `${GHPATH}/imagesHelp/turkey.png`,
  `${GHPATH}/imagesHelp/turkeyDiscussion.png`,
